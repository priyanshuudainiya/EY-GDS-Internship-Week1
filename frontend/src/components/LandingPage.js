  ...
  return (
    <div className="container text-center mt-5" style={{ minHeight: "100vh" }}>
      <div className="jumbotron bg-light p-5">
        <h1 className="display-4">Welcome to RealCollab</h1>
        <p className="lead">
          RealCollab is your go-to platform for seamless real-time
          collaboration. Work together on documents, share ideas, and
          communicate effortlessly with your team.
        </p>
        <hr className="my-4" />
        <p>
          Whether you're working on a team project or just need to organize your
          thoughts, RealCollab offers all the features you need to stay
          productive.
        </p>
        <div className="mt-4">
